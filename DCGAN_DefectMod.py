...
class DCGANTrainer:
    def __init__(self, data_path, ann_file_path, img_size=64, channels=1, latent_dim=100, n_epochs=10, batch_size=64, lr=0.0002, b1=0.5, b2=0.999, sample_interval=400, oversample='N'):
...
#         )
    ...
    def save_model(self, discriminator, epoch, model_path="dcgan_models"): #generator paramter removed
        """
