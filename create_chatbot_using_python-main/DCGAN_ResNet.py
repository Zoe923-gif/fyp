...
class DCGANTrainer:
    ...
    def train(self, val_data_path, val_ann_file_path):
        ...
        for epoch in range(self.n_epochs):
            ...
            acc, _, _, f1 = self.evaluate_discriminator(val_data_path, val_ann_file_path)
    ...
    def plot_acc_scores(self):
        os.makedirs("Training result", exist_ok=True)
        # Plot the accuracy scores over epochs
        plt.figure(figsize=(10, 5))
        plt.plot(self.accuracy, label='Accuracy Score', color='green')
        plt.xlabel('Epochs')
        plt.ylabel('Accuracy')
        plt.legend()
        plt.title('Training Accuracy Score Over Epochs')
        #plt.show()
        plt.savefig(os.path.join("Training result", "Accuracy.png"))
        plt.close()
    ...
    def plot_f1_scores(self):
        ...
        plt.figure(figsize=(10, 5))
        plt.plot(self.val_f1_scores, label='Validation F1 Score', color='green')
        plt.xlabel('Epochs')
        plt.ylabel('F1 Score')
        plt.legend()
        plt.title('Validation F1 Score Over Epochs')
        plt.savefig(os.path.join("Training result", "F1-Score.png"))
        plt.close()
